<template>
  <div class="padding">
    <!-- 输入网格数、仓位等比乘数、投入仓位、最高区间（现价）、最低区间（预测位置） -->
    <el-row type="flex" justify="space-between" align="bottom">
      ...
      <el-col :span="2">
        <el-button type="primary" @click="calcPosition()">生成网格</el-button>
      </el-col>
    </el-row>
    <el-row class="margin-top">
      <el-table :data="result" style="width: 100%">
        ...
        <el-table-column prop="position" label="合计仓位(本位币）" width="180">
        </el-table-column>
        <el-table-column prop="buy_price" label="买入价格(交易币）" width="180">
        </el-table-column>
        <el-table-column prop="count" label="数量(交易币）"> </el-table-column>
      </el-table>
    </el-row>
  </div>
</template>
